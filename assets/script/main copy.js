  ...
  if (isOnlyTrimesterFee) {
    ...
    if (totalDiscountAmount === 0) {
      ...
      if (finalAmount >= firstGross) {
        ...
        firstInstallment = Math.min(finalAmount, Math.max(minFirst, desiredFirst));
        ...
        secondInstallmentDesc = remaining === 0 ? "No payment required" : "50% of remaining";
        thirdInstallmentDesc = remaining === 0 ? "No payment required" : "50% of remaining";
      }
    }
  }
